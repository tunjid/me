...
import com.tunjid.me.core.ui.lazy.layout.LazyLayoutAnimation
...
internal class LazyStaggeredGridItemPlacementAnimator {
    ...
    private var keyIndexMap: com.tunjid.me.core.ui.lazy.layout.LazyLayoutKeyIndexMap =
        com.tunjid.me.core.ui.lazy.layout.LazyLayoutKeyIndexMap
    ...
    private val LazyStaggeredGridMeasuredItem.hasAnimations: Boolean
        get() {
            for (index in 0 until placeablesCount) {
                if (getParentData(index).specs != null) return true
            }
            return false
        }
}
